...
class App extends Component {
  constructor(){
    ...
    this.state = {
      ...
      //for edit we are taking act and idx(index)
      act : 0,
      idx : '',
      datas : []
    }
...
//in method we have to use let to define and declare
//here handlesubmit is for add operation
  handleSubmit=(e)=>{
    e.preventDefault();
    ...
    //let datas = this.state.datas;
    //to reset we use this.setState method
    this.setState({
      datas : datas,
      act : 0
    })
